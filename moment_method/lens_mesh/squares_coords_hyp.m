...
function [squares_column, centers_column, edge_l] = squares_coords_hyp(width, F, e_r, num_width_splits)

%calculate maximum psi value
psi_max_val = psi_max2(e_r,F,width-0.2);
...
for iter=1:(squares_thick)
    ...
    new_first_y = abs(hyperbola_y(max_x, (iter-1).*edge_length));
